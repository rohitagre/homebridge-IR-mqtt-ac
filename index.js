...
acpartner.prototype = {
  getServices: function () {
    ...
    var activeCharacteristic = heaterCoolerService.getCharacteristic(
      Characteristic.Active
    );
    var currentHeaterCoolerStateCharacteristic =
      heaterCoolerService.getCharacteristic(
        Characteristic.CurrentHeaterCoolerState
      );
    var targetHeaterCoolerStateCharacteristic =
      heaterCoolerService.getCharacteristic(
        Characteristic.TargetHeaterCoolerState
      );
    var currentTemperatureCharacteristic =
      heaterCoolerService.getCharacteristic(Characteristic.CurrentTemperature);
    var swingModeCharacteristic = heaterCoolerService.addCharacteristic(
      Characteristic.SwingMode
    );
    var coolingThresholdTemperatureCharacteristic =
      heaterCoolerService.getCharacteristic(
        Characteristic.CoolingThresholdTemperature
      );
    var heatingThresholdTemperatureCharacteristic =
      heaterCoolerService.addCharacteristic(
        Characteristic.HeatingThresholdTemperature
      );
    var rotationSpeedCharacteristic = heaterCoolerService.addCharacteristic(
    ...
    activeCharacteristic.on("set", (value, callback) => {
      if (value == Characteristic.Active.INACTIVE) {
        ...
        currentHeaterCoolerStateCharacteristic.updateValue(
        ...
        if (
          targetHeaterCoolerStateCharacteristic.value ===
          Characteristic.TargetHeaterCoolerState.AUTO
        ) {
          heatingThresholdTemperatureCharacteristic.updateValue(
            this.maxTemperature
          );
          coolingThresholdTemperatureCharacteristic.updateValue(
            this.Temperature
          );
        } else if (
          targetHeaterCoolerStateCharacteristic.value !==
    ...
    coolingThresholdTemperatureCharacteristic.on("set", (value, callback) => {
    ...
    heatingThresholdTemperatureCharacteristic.on("set", (value, callback) => {
      if (
        targetHeaterCoolerStateCharacteristic.value ===
        Characteristic.TargetHeaterCoolerState.AUTO
      ) {
    ...
    that.mqttClient.on("message", (topic, message) => {
      ...
      if (topic == that.mqttTopic["powerstat"]) {
        ...
        console.log("Received temperature update: " + message);
